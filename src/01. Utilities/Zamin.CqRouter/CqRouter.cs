namespace Zamin.CqrsRouter
{
    ...
    /// </summary>
    public class CqRouter : ICqRouter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CqRouter"/> class.
        /// </summary>
        /// <param name="serviceFactory">The single instance factory.</param>
        public CqRouter(ServiceFactory serviceFactory)
        {
