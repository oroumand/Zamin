...
using Zamin.CqrsRouter.Pipeline;
...
namespace Zamin.CqrsRouter.HandlerRegistrations.Registration
{
    public static class CqRouterServiceRegistrar
    {
        public static void AddCqRouterClasses(IServiceCollection services, IEnumerable<Assembly> assembliesToScan)
        {
        ...
        public static void AddRequiredServices(IServiceCollection services, CqRouterServiceConfiguration serviceConfiguration)
        {
            ...
            services.Add(new ServiceDescriptor(typeof(ICqRouter), serviceConfiguration.MediatorImplementationType, serviceConfiguration.Lifetime));
        }
    }
}
