...
public class WebUserInfoService : IUserInfoService
{
    ...
    public int UserId() => int.Parse(_httpContextAccessor.HttpContext.User?.GetClaim(ClaimTypes.NameIdentifier) ?? "0");
    public string GetUsername() => _httpContextAccessor.HttpContext.User?.GetClaim(ClaimTypes.Name);
    public string GetFirstName() => _httpContextAccessor.HttpContext.User?.GetClaim(ClaimTypes.GivenName);
    public string GetLastName() => _httpContextAccessor.HttpContext.User?.GetClaim(ClaimTypes.Surname);
