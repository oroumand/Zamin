...
public interface ITranslator
{
    ...
    string this[string name, string culture] { get; set; }

    string this[string name, params string[] arguments] { get; set; }

    string this[string name, string culture, params string[] arguments] { get; set; }

    string this[char separator, params string[] names] { get; set; }

    string this[char separator, string culture, params string[] names] { get; set; }
